...
public class ConvertersStorage {
    ...
    // MessageStorage converter
    @TypeConverter
    public static MessageStorage fromMessageString(String value) {
        return value == null ? null : new Gson().fromJson(value, MessageStorage.class);
    }

    @TypeConverter
    public static String messageToString(MessageStorage message) {
        return message == null ? null : new Gson().toJson(message);
    }
